...
class SignUP(View):
    ...
    def post(self, request):
        ...
        if CustomUser.objects.filter(email = data.get('email')).exists():
            ...
            return redirect(f'/auth/signup/?e={refereemail}')
            ...
            messages.info(request,'Agree whith the privacy policy of us!')
            ...
            if CustomUser.objects.filter(email = refereemail).exists():
                us = CustomUser.objects.get(email = refereemail)
